...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>SMC Last School Attended Data</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- cardbox end -->
        ...
        <?php include('../smc/includes/chartsfloor1smclastschool.php') ?>
        <!-- Charts 1st floor end -->

        <!-- Charts 2st floor start -->
        <?php include('../smc/includes/chartsfloor2smclastschool.php') ?>
    ...
    <script src="./data/chart1smclastschool.js" charset="utf-8"></script>
    <script src="./data/chart2smclastschool.js" charset="utf-8"></script>

    <script src="./data/mapsmcdata.js" charset="utf-8"></script>
    <script src="./data/mapsmclastscool.js" charset="utf-8"></script>
