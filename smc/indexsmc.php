  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- cardbox end -->
        ...
        <?php include('../smc/includes/chartsfloor1SMC.php') ?>
        <!-- Charts 1st floor end -->

        <!-- Charts 2st floor start -->
        <?php include('../smc/includes/chartsfloor2SMC.php') ?>
    ...
    <script src="./data/chart1smc.js" charset="utf-8"></script>
    <script src="./data/chart2smc.js" charset="utf-8"></script>

    <script src="./data/mapsmcdata.js" charset="utf-8"></script>
    <script src="./data/mapsmc.js" charset="utf-8"></script>
