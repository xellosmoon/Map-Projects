...
info.update = function(props) {
    this._div.innerHTML = '<h4>Baranggay Population</h4>' + (props ?
        '<b>' + props.name + '</b><br />' + props.bsba + ' BSBA' + '</b><br />' + props.nursing + ' Nursing'+ '</b><br />' + props.hm + ' HM' :
...
var overlayMaps = {
    "BSBA": geojsonGroup, // Add the first layer group to the overlay maps
    "Nursing": geojsonGroup2, // Add the second layer group to the overlay maps
    "HM": geojsonGroup3
};
...
function style(feature) {
    return {
        fillColor: getColor(feature.properties.bsba),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
...
function style2(feature) {
    return {
        fillColor: getColor(feature.properties.nursing),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
...
function style3(feature) {
    return {
        fillColor: getColor(feature.properties.hm),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
