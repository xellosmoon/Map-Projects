...
info.update = function(props) {
    this._div.innerHTML = '<h4>Baranggay Population</h4>' + (props ?
        '<b>' + props.name + '</b><br />' + props.pop + ' Students' + '</b><br />' + props.male + ' Males'+ '</b><br />' + props.female + ' Females' :
...
var overlayMaps = {
    "Total Population": geojsonGroup, // Add the first layer group to the overlay maps
    "Males": geojsonGroup2, // Add the second layer group to the overlay maps
    "Females": geojsonGroup3
};
...
function style2(feature) {
    return {
        fillColor: getColor(feature.properties.male),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
...
function style3(feature) {
    return {
        fillColor: getColor(feature.properties.female),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
