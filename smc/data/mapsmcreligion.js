...
info.update = function(props) {
    this._div.innerHTML = '<h4>Baranggay Population</h4>' + (props ?
        '<b>' + props.name + '</b><br />' + props.roman + ' Roman Catholics' + '</b><br />' + props.islam + ' Muslims'+ '</b><br />' + props.bornagain + ' Born Agains' :
...
var overlayMaps = {
    "Roman Catholics": geojsonGroup, // Add the first layer group to the overlay maps
    "Islam": geojsonGroup2, // Add the second layer group to the overlay maps
    "Born Again": geojsonGroup3
};
...
function style(feature) {
    return {
        fillColor: getColor(feature.properties.roman),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
...
function style2(feature) {
    return {
        fillColor: getColor(feature.properties.islam),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
...
function style3(feature) {
    return {
        fillColor: getColor(feature.properties.bornagain),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
