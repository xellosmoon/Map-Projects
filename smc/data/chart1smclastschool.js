...
fetch('http://localhost/Capstone2/smc/data/smclastschool.csv')
  ...
  .then(csvData => {
    ...
    var ctx = document.getElementById('chart1smclastschool').getContext('2d');
    window.chart1smclastschool = new Chart(ctx, config);
  })
