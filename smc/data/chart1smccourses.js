...
fetch('http://localhost/Capstone2/smc/data/smccourses.csv')
  ...
  .then(csvData => {
    ...
    var ctx = document.getElementById('chart1smccourses').getContext('2d');
    window.chart1smccourses = new Chart(ctx, config);
  })
