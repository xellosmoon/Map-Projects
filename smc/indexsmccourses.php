  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- cardbox end -->
        ...
        <?php include('../smc/includes/chartsfloor1smccourses.php') ?>
        <!-- Charts 1st floor end -->

        <!-- Charts 2st floor start -->
        <?php include('../smc/includes/chartsfloor2smccourses.php') ?>
    ...
    <script src="./data/chart1smccourses.js" charset="utf-8"></script>
    <script src="./data/chart2smccourses.js" charset="utf-8"></script>

    <script src="./data/mapsmcdata.js" charset="utf-8"></script>
    <script src="./data/mapsmccourses.js" charset="utf-8"></script>
